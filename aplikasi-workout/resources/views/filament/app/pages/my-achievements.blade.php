<x-filament-panels::page>
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        ...
        <div class="p-6 bg-white dark:bg-gray-800/50 rounded-xl shadow-sm hover:shadow-lg transition-shadow duration-300 flex flex-col items-center text-center">
            ...
            {{-- Gambar Lencana --}}
            <img src="{{ isset($achievement['image_url']) ? url('storage/' . $achievement['image_url']) : 'https://via.placeholder.com/100' }}"
                alt="{{ $achievement['name'] }}" class="w-24 h-24 mb-4 rounded-full object-cover">
            {{-- Nama Lencana --}}
